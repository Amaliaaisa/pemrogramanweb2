...
<div class="container">
            ...
            <div class="col-12">
                <table class="table table-striped">
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">JU</th>
                        <th scope="col">Pengarang</th><th scope="col">ID</th>
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/daftar_buku')?>" id="formTambah" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
