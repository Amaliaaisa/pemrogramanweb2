...
<body>
  <div class="container">
    <h1>Daftar Buku</h1>
    <div class="my-3">
      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModal"><i class="bi bi-plus-circle-fill"></i> Tambah</button>
    </div>
    <div class="row">
      <div class="col-12">
          ...
          <tbody>
            ...
            <?php foreach($Data->getData() as $buku): ?>
              <tr>
                ...
                <td>
                  <a href="/index.php/edit?id=<?php echo $buku->getid(); ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i> Edit</a>
                  <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal" data-bs-id="<?php echo $buku->getid(); ?>"><i class="bi bi-trash"></i> Hapus</button>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
